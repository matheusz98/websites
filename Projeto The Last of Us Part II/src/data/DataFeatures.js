import ImageOne from '../images/01.jfif';
import ImageTwo from '../images/02.jpg';
import ImageThree from '../images/03.jpg';


export const FeaturesContent = {
    title1: "Uma história complexa e emocionante",
    paragraph1: "Vivencie os conflitos morais cada vez maiores criados pela caçada implacável de Ellie em busca de vingança. O ciclo de violência deixado no caminho dela desafiará as suas noções de certo ou errado, bem ou mal e herói ou vilão.",
    img1: ImageOne,
    alt1: "Ellie e Dina",
